...
my $dir_reportes = "$FindBin::Bin/../reportesdot";
mkdir $dir_reportes unless -d $dir_reportes;

my $ok_png = $arbol->generarPNG(
    "$dir_reportes/arbol_b_suministros.dot",
    "$dir_reportes/arbol_b_suministros.png"
);
